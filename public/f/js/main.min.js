...
$(function(){$("input, textarea").placeholder(),$.fn.dropdownHover&&$('[data-hover="dropdown"]').dropdownHover(),$("table").addClass("table table-bordered table-condensed").parent().addClass("table-responsive"),"ontouchstart"in window||function(){var a=$(window),b=a.height();$(".table-responsive table").each(function(){var c=$(this),d=c.parent(),e=$("<div>"),f=$('<div class="table-responsive">'),g=c.width(),h=d.height(),i=d.width(),j=d.offset();c.removeAttr("style width height"),e.css({height:1,width:g}),f.append(e).insertAfter(d).css({position:"fixed"}).on("scroll",function(){d[0].scrollLeft=this.scrollLeft}),d.on("scroll",function(){f[0].scrollLeft=this.scrollLeft}),a.on("scroll",function(){g>h||c.height()<b||b+a.scrollTop()>j.top+i?f.hide():f.show().scrollLeft(d.scrollLeft())}).on("resize",function(){f.css({width:h,bottom:-parseInt(d.css("margin-bottom"))}),a.trigger("scroll"),b=a.height(),g=c.width(),h=d.height(),i=d.width(),j=d.offset()}).trigger("resize")})}(),"cubingchina.com"===location.hostname&&(function(a,b,c,d,e,f,g){a.GoogleAnalyticsObject=e,a[e]=a[e]||function(){(a[e].q=a[e].q||[]).push(arguments)},a[e].l=1*new Date,f=b.createElement(c),g=b.getElementsByTagName(c)[0],f.async=1,f.src=d,g.parentNode.insertBefore(f,g)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-3512083-6","cubingchina.com"),ga("send","pageview"))});
$(function(){$("input, textarea").placeholder(),$.fn.dropdownHover&&$('[data-hover="dropdown"]').dropdownHover(),$(".wrapper table").addClass("table table-bordered table-condensed").parent().addClass("table-responsive"),"ontouchstart"in window||function(){var a=$(window),b=a.height();$(".table-responsive table").each(function(){var c=$(this),d=c.parent(),e=$("<div>"),f=$('<div class="table-responsive">'),g=c.width(),h=c.height(),i=d.width(),j=d.height(),k=d.offset();c.removeAttr("style width height"),e.css({height:1,width:g}),f.append(e).insertAfter(d).css({position:"fixed"}).on("scroll",function(){d[0].scrollLeft=this.scrollLeft}),d.on("scroll",function(){f[0].scrollLeft=this.scrollLeft}),a.on("scroll",function(){i>=g||2*b>h||b+a.scrollTop()>k.top+j?f.hide():f.show().scrollLeft(d.scrollLeft())}).on("resize",function(){f.css({width:i,bottom:-parseInt(d.css("margin-bottom"))}),a.trigger("scroll"),b=a.height(),g=c.width(),h=c.height(),i=d.width(),j=d.height(),k=d.offset()}).trigger("resize")})}(),"cubingchina.com"===location.hostname&&(function(a,b,c,d,e,f,g){a.GoogleAnalyticsObject=e,a[e]=a[e]||function(){(a[e].q=a[e].q||[]).push(arguments)},a[e].l=1*new Date,f=b.createElement(c),g=b.getElementsByTagName(c)[0],f.async=1,f.src=d,g.parentNode.insertBefore(f,g)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-3512083-6","cubingchina.com"),ga("send","pageview"))});