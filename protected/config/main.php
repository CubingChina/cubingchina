...
$config = [
	...
	'components'=>[
		...
		'db'=>[
			'connectionString'=>'mysql:host=' . DB_HOST . ';dbname=cubingchina' . (DEV ? '_dev' : ''),
		...
		'wcaDb'=>[
			...
			'pdoClass'=>'QueryCheckPdo',
			'connectionString'=>'mysql:host=' . DB_HOST . ';dbname=wca_v2_' . $wcaDb,
			'emulatePrepare'=>true,
			'username'=>DB_USER,
			'password'=>DB_PASSWORD,
			'charset'=>'utf8',
	...
	'params'=>[
		...
		'regulations'=>[
			'common'=>[
				...
				'Disclaimer: If a competitor completes registration and payment without fully understanding the competition information, event rules, refund policy, registration guidelines and other relevant contents, Cubing China and the organizing team shall not be liable for any resulting financial losses.'
			],
			'common_zh'=>[
				...
				'免责声明：选手如在未充分了解比赛信息、赛事规则、退费政策及报名须知等内容的情况下完成报名并支付费用，因此产生的任何费用损失，粗饼网及赛事主办方概不承担。'
			],
			'special'=>[
