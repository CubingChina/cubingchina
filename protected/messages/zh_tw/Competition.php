...
return array (
  ...
  'Each event has a limited number of competitors.' => '每個項目的報名人數有限。',
  'Edit Ticket' => '編輯入場券信息',
  'End Date' => '結束日期',
  'Entry Fee' => '報名費',
  'Events' => '項目',
  ...
  'Competitors can only register for one in the WCA series. Please carefully review the competition rules regarding the WCA series before registering for this competition.' => '選手只能報名WCA系列賽中的一場比賽，報名本比賽前請仔細查看比賽規則對WCA系列賽的說明。',
  'Ticket' => '入場券',
  'Travel' => '交通',
  'Travel Info' => '交通信息',
  'Type' => '類型',
  ...
  'Competition Explanation' => '賽事說明',
  'Trial competition' => '<strong>試點賽事</strong>',
  'Competition with new organizers' => '<strong>新晉主辦賽事</strong>',
  'Large-scale competition' => '<strong>大型賽事</strong>',
  'Other' => '<strong>其他賽事</strong>',
  ...
  'Only competitors can buy tickets.' => '只有選手可以購買入場券。',
